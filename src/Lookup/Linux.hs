...
posAndKeycode = over (traverse ∘ _2) (\s → "<" ⊕ s ⊕ ">") P.posAndXkbKeycode
...
actionAndLinuxAction =
    ...
    , (A.KP_5, Symbol "KP_5")
    , (A.KP_6, Symbol "KP_6")
    , (A.KP_Comma, Symbol "KP_Separator")
    , (A.KP_1, Symbol "KP_1")
    , (A.KP_2, Symbol "KP_2")
    , (A.KP_3, Symbol "KP_3")
    ...
    , (A.Ro, Symbol "Romaji")
    , (A.Muhenkan, Symbol "Muhenkan")
    , (A.Henkan, Symbol "Henkan")
    , (A.Katakana, Symbol "Katakana")
    ]
...
singleIncludes =
    ...
    , (SingletonKey P.Alt_R       (Dead D.Compose), "include \"compose(ralt)\"")
    , (SingletonKey P.Win_L       (Dead D.Compose), "include \"compose(lwin)\"")
    , (SingletonKey P.Win_R       (Dead D.Compose), "include \"compose(rwin)\"")
    , (SingletonKey P.Menu        (Dead D.Compose), "include \"compose(menu)\"")
    , (SingletonKey P.Control_R   (Dead D.Compose), "include \"compose(rctrl)\"")
    , (SingletonKey P.Control_L   (Dead D.Compose), "include \"compose(lctrl)\"")
    , (SingletonKey P.CapsLock    (Dead D.Compose), "include \"compose(caps)\"")
    , (SingletonKey P.Iso         (Dead D.Compose), "include \"compose(102)\"")
    , (SingletonKey P.Pause       (Dead D.Compose), "include \"compose(paus)\"")
    , (SingletonKey P.PrintScreen (Dead D.Compose), "include \"compose(prsc)\"")
    , (SingletonKey P.ScrollLock  (Dead D.Compose), "include \"compose(sclk)\"")
...
charAndString =
    ...
    , ('๙', "Thai_lekkao")
    , ('ㄱ', "Hangul_Kiyeog")
    , ('ㄲ', "Hangul_SsangKiyeog")
    , ('ㄳ', "Hangul_KiyeogSios")
    , ('ㄴ', "Hangul_Nieun")
    , ('ㄵ', "Hangul_NieunJieuj")
    , ('ㄶ', "Hangul_NieunHieuh")
    , ('ㄷ', "Hangul_Dikeud")
    , ('ㄸ', "Hangul_SsangDikeud")
    , ('ㄹ', "Hangul_Rieul")
    , ('ㄺ', "Hangul_RieulKiyeog")
    , ('ㄻ', "Hangul_RieulMieum")
    , ('ㄼ', "Hangul_RieulPieub")
    , ('ㄽ', "Hangul_RieulSios")
    , ('ㄾ', "Hangul_RieulTieut")
    , ('ㄿ', "Hangul_RieulPhieuf")
    , ('ㅀ', "Hangul_RieulHieuh")
    , ('ㅁ', "Hangul_Mieum")
    , ('ㅂ', "Hangul_Pieub")
    , ('ㅃ', "Hangul_SsangPieub")
    ...
    , ('ㅣ', "Hangul_I")
    , ('ᆨ', "Hangul_J_Kiyeog")
    , ('ᆩ', "Hangul_J_SsangKiyeog")
    , ('ᆪ', "Hangul_J_KiyeogSios")
    , ('ᆫ', "Hangul_J_Nieun")
    , ('ᆬ', "Hangul_J_NieunJieuj")
    , ('ᆭ', "Hangul_J_NieunHieuh")
    , ('ᆮ', "Hangul_J_Dikeud")
    , ('ᆯ', "Hangul_J_Rieul")
    , ('ᆰ', "Hangul_J_RieulKiyeog")
    , ('ᆱ', "Hangul_J_RieulMieum")
    , ('ᆲ', "Hangul_J_RieulPieub")
    , ('ᆳ', "Hangul_J_RieulSios")
    , ('ᆴ', "Hangul_J_RieulTieut")
    , ('ᆵ', "Hangul_J_RieulPhieuf")
    , ('ᆶ', "Hangul_J_RieulHieuh")
    , ('ᆷ', "Hangul_J_Mieum")
    , ('ᆸ', "Hangul_J_Pieub")
    , ('ᆹ', "Hangul_J_PieubSios")
    , ('ᆺ', "Hangul_J_Sios")
    , ('ᆻ', "Hangul_J_SsangSios")
    , ('ᆼ', "Hangul_J_Ieung")
    , ('ᆽ', "Hangul_J_Jieuj")
    , ('ᆾ', "Hangul_J_Cieuc")
    , ('ᆿ', "Hangul_J_Khieuq")
    ...
    , ('ᇁ', "Hangul_J_Phieuf")
    , ('ᇂ', "Hangul_J_Hieuh")
    , ('ㅭ', "Hangul_RieulYeorinHieuh")
    , ('ㅱ', "Hangul_SunkyeongeumMieum")
    , ('ㅸ', "Hangul_SunkyeongeumPieub")
    , ('ㅿ', "Hangul_PanSios")
    , ('ㆁ', "Hangul_KkogjiDalrinIeung")
    , ('ㆄ', "Hangul_SunkyeongeumPhieuf")
    , ('ㆆ', "Hangul_YeorinHieuh")
    , ('ㆍ', "Hangul_AraeA")
    , ('ㆎ', "Hangul_AraeAE")
    , ('ᇫ', "Hangul_J_PanSios")
    , ('ᇰ', "Hangul_J_KkogjiDalrinIeung")
    , ('ᇹ', "Hangul_J_YeorinHieuh")
