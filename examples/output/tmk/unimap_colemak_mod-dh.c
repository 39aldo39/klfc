...
const action_t actionmaps[][UNIMAP_ROWS][UNIMAP_COLS] PROGMEM = {
    ...
    [0] = UNIMAP(
     ...
     TAB,   Q,   W,   F,   P,   B,   J,   L,   U,   Y,SCLN,LBRC,RBRC,     BSLS,      DEL, END,PGDN,      P7,  P8,  P9,PPLS,
    CAPS,   A,   R,   S,   T,   G,   K,   N,   E,   I,   O,QUOT,     NUHS, ENT,                          P4,  P5,  P6,PCMM,
     FN0,NUBS,   Z,   X,   C,   D,   V,   M,   H,COMM, DOT,SLSH,       RO, FN1,            UP,           P1,  P2,  P3,PENT,
